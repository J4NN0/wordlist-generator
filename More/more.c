...
static void info_wep();
static void info_wpa();
static void info_wl();
static void develop();
static int let_me_see(int miss);
...
void info_wl() {
    ...
    if((let_me_see(3 + 3 + 3 + 3 + 3)) == 0) return;
    ...
    if((let_me_see(3 + 3 + 3 + 3)) == 0) return;
